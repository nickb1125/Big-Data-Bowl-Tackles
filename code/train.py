...
if False:
    ...
    print(f"Training TackleNet bag...")
    print("---------------------")
    losses = []
    val_losses = []
    val_accuracy = []
    for epoch in range(num_epochs):
        ...
        print(f"Length of exact_correct: {len(exact_correct)}")
...
for bag in range(1):
    ...
    with open("model_{bag}.pkl", f'wb') as outp:  # Overwrites any existing file.
